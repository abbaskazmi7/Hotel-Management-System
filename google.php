    ...
    <div class="container-fluid">
        <div class="row align-items-center align-self-center justify-content-center" style="height: 100vh;">
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="text-center" colspan="2">Description here</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <a href="bookNowBack.php" class="btn btn-sm btn-success">CHECKIN</a>
                        </div>
                    </div>
                </div>                
            </div>
            ...
            <form action="" method="post">
                ...
                <input type="password" class="form-control" name="mail" placeholder="Password">
